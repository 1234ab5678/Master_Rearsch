...
path="F:/MyRearsch/Bridgecrack_detection/dataset/dataset1"#基础路径
...
all_loss=[]#定义损失
epoch=50
#save_path='./Model/Model4_'+str(epoch)+'epoch/'
#if not os.path.exists(save_path):
#         os.makedirs(save_path)
save_path = './Model/Model4_' + str(epoch+1) + 'epoch/'
...
np.savetxt(save_path+'time.txt',time)
